          ...
          <li>
            ...
            <div class="media-body" id="table">
                  ...
                  <div class="pull-right row">
                      <form class="col-md-6" action="<?= BASE_URL(); ?>Home/insertView/<?php echo $libro['Cod_Proyecto'] ?>">
                        <button class="btn btn-primary">Editar</button>
                      </form>
                      <form class="col-md-6" action="<?= BASE_URL(); ?>Home/Delete/<?php echo $libro['Cod_Proyecto'] ?>">
